...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle) {
	...
	// FP.6b : use the methods TrafficLight::getCurrentPhase and TrafficLight::waitForGreen to block the
...
{
	// FP.6a : In Intersection.h, add a private member _trafficLight of type TrafficLight. At this position,
...
void Intersection::processVehicleQueue() {
	...
	std::cout << "Intersection #" << _id << "::processVehicleQueue: thread id = " << std::this_thread::get_id()
						<< std::endl;
